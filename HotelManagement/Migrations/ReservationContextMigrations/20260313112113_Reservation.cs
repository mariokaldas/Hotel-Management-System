...
namespace HotelManagement.Migrations.ReservationContextMigration
{
    /// <inheritdoc />
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    zip_code = table.Column<string>(type: "nchar(10)", maxLength: 10, nullable: false),
                    room_type = table.Column<string>(type: "nchar(10)", maxLength: 10, nullable: false),
                    room_floor = table.Column<string>(type: "nchar(10)", maxLength: 10, nullable: false),
                    room_number = table.Column<string>(type: "nchar(10)", maxLength: 10, nullable: false),
                    total_bill = table.Column<double>(type: "float", nullable: false),
                    payment_type = table.Column<string>(type: "nchar(10)", maxLength: 10, nullable: false),
                    card_type = table.Column<string>(type: "nchar(10)", maxLength: 10, nullable: false),
                    ...
                    card_cvc = table.Column<string>(type: "nchar(10)", maxLength: 10, nullable: false),
